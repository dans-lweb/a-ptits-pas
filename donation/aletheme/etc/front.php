...
function ale_exclude_search_pages($query) {
	if ($query->is_search) {
		$query->set('post_type', array('post', 'events', 'news'));
	}
...
function ale_enqueue_scripts() {
    ...
    wp_register_script( 'flexslider', THEME_URL . '/js/libs/jquery.flexslider-min.js', array( 'jquery' ), ALETHEME_THEME_VERSION, true );
    wp_register_script( 'popup', THEME_URL . '/js/libs/magnific-popup.js', array( 'jquery' ), ALETHEME_THEME_VERSION, true );
    wp_register_script( 'easydropdown', THEME_URL . '/js/libs/jquery.easydropdown.min.js', array( 'jquery' ), ALETHEME_THEME_VERSION, true );
    wp_register_script( 'circliful', THEME_URL . '/js/libs/jquery.circliful.min.js', array( 'jquery' ), ALETHEME_THEME_VERSION, true );
    wp_register_script( 'circliful-init', THEME_URL . '/js/libs/circliful.js', array( 'jquery' ), ALETHEME_THEME_VERSION, true );
    wp_register_script( 'paypal-button', THEME_URL . '/js/libs/paypal-button.min.js', array( 'jquery' ), ALETHEME_THEME_VERSION, true );
    wp_register_script( 'isotope', THEME_URL . '/js/libs/isotope.pkgd.min.js', array( 'jquery' ), ALETHEME_THEME_VERSION, true );
    wp_register_script( 'ale_cookie', THEME_URL . '/js/libs/jquery.cookie.js', array( 'jquery' ), ALETHEME_THEME_VERSION, true );
    wp_register_script( 'ale_colorpicker', THEME_URL . '/js/libs/colorpicker.js', array( 'jquery' ), ALETHEME_THEME_VERSION, true );
    ...
    wp_enqueue_script( 'circliful-init' );
    wp_enqueue_script( 'paypal-button' );
    wp_enqueue_script( 'isotope' );
    wp_enqueue_script( 'ale_cookie' );
    wp_enqueue_script( 'ale_colorpicker' );
