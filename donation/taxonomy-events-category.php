    ...
    <div class="center cf">
        ...
        <section class="col-8 blog-page">
            ...
            if( $stickies ) {
                ...
                global $wp_query;
                query_posts( array_merge($wp_query->query, $args , array('post_type' => 'events')));
            }else{
                wp_reset_query(); query_posts('&post_type=events');
            }
            ?>
                ...
                <article class="big">
                    ...
                    <div class="cf">
                        <div class="info events">
                            <div class="calendar"><span class="fa fa-calendar"></span><?php echo ale_get_meta('date'); ?><?php if(ale_get_meta('starttime')){ _e(' at ','aletheme');} echo ale_get_meta('starttime'); ?><?php if(ale_get_meta('endtime')){ _e(' - ','aletheme');} echo ale_get_meta('endtime'); ?></div>
                            <?php if(ale_get_meta('address')): ?>
                                <div class="location"><?php echo ale_get_meta('address'); ?></div>
                            <?php endif; ?>
                            <?php
